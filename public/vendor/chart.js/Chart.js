...
*/
    ...
    function boundingRects(vm) {
        ...
        return {
            ...
            inner: {
                x: bounds.left + border - transport.l,
                y: bounds.top + border - transport.t,
                w: width - border - transport.l - border - transport.r,
                h: height - border - transport.t - border - transport.b,
            },
        };
    }
