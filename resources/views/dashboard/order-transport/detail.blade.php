...
@section('container')
    ...
    <div class="col-xl-8 p-0 mb-3 mb-md-5">
        <a class="btn btn-primary me-0 me-3 w-100 w-lg-auto mb-3 mb-lg-0" href="{{ route('order-transport.index') }}">Kembali ke Data Tabel</a>
        <form action="{{ route('order-transport.destroy', $orderTransport->id) }}" class="d-inline w-100 w-lg-auto mb-3 mb-lg-0" method="post">
            @csrf
            @method("delete")
